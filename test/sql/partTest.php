...
class partTest extends PHPUnit\Framework\TestCase{
	...
	public function testFunctionFromSQL(){
		$user = $this->from;
		$part = sql::YEAR($user('2019-04-19'));
		$this->assertEquals('YEAR("2019-04-19")', (string)$part);
		$part = sql::YEAR($user['createdAt']);
